                                ...
                                <div class="row mb-4">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <label for="inputPassword6" class="col-form-label">: <strong class="ml-2">31312</strong></label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-4">
                                            ...
                                            <div class="col-8">
                                                <label for="inputPassword6" class="col-form-label">: <strong class="ml-2">ds</strong></label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-4">
                                    ...
                                    <div class="col">
                                        <div class="row ml-4">
                                            ...
                                            <div class="col-8">
                                                <label for="inputPassword6" class="col-form-label">: <strong class="ml-2">Yanto</strong></label>
                                            </div>
                                        </div>
                                        <div class="row ml-4">
                                            <div class="col-4">
                                            ...
                                            <div class="col-8">
                                                <label for="inputPassword6" class="col-form-label">: <strong class="ml-2">Jlr 7</strong></label>
                                            </div>
                                        </div>
                                        <div class="row ml-4">
                                            <div class="col-4">
